...
<body>
			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<h1>申込確認（21冬期） 申し込み状況確認</h1>
					</div>

					<div class="section-body">
						<div class="row">
							<div class="col-12">
								<h4 class="d-inline-block mr-3"><?= $CONF['place_winter21'][$EDATA['place_winter21']] ?>会場</h4>
														...
														<table class="table table-striped table-sm">
															...
															<tbody>
																<?php foreach( $detail_val['apply'] as $apply_id => $apply ): ?>
																	<tr>
																		<td>
																			<a href="javascript:void(0);" onclick="cancel_apply('<?= $apply_id ?>', '<?= $CONF['place_winter21'][$EDATA['place_winter21']] ?>会場', '<?= $period ?>', '<?= $apply['juku_name'] ?>');">
						...
						<div class="row justify-content-center">
							...
							<div class="col-6">
								<?php echo form_button(array(
									...
									'content'	=> 'ダウンロード',
									'onclick'	=> 'location.href=\'' . site_url('admin/winter21/dl/' . $EID) . '\''
								)); ?>
							</div>
						</div> <!-- end of .row -->
	...
	<script src="<?= base_url('js/admin/winter21_ac.js')?>?var=<?= CACHES_CLEAR_VERSION ?>"></script>
</body>
</html>
