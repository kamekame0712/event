			...
			<?php if( $ERR_STR == '' ): ?>
				...
				<div class="reception-slip-info my-5">
					<div class="image-wrapper">
						<img src="<?= base_url('img/winter21/how_to_apply1.png') ?>" alt="受付票を保存">
					</div>
					<div class="arrow-triangle-right"></div>
					<div class="image-wrapper">
						<img src="<?= base_url('img/winter21/how_to_apply2.png') ?>" alt="受付票を当日持参">
					</div>
				</div>
				...
				<div class="row justify-content-center my-5">
					<div class="col-12 col-md-8">
						...
						当日は、受付票を必ずご持参いただき、受付にお見せください。
					</div>
				</div>

				<h2 class="complete-comment"><span>受付票は大切に保管いただき、展示会当日必ずご持参ください。</span></h2>
				...
				<div class="row justify-content-center my-5">
					<div class="col-12 col-md-4 mb-2">
						<a href="<?= site_url('winter21/reception?reception=' . $RECEPTION) ?>" class="btn-winter21 btn-enabled">受付票&nbsp;&nbsp;&nbsp;<i class="fas fa-chevron-right"></i></a>
					</div>
				</div> <!-- end of .row -->
			<?php else: ?>
