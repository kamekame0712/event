...
<body>
	<div class="wrapper">
		...
		<div class="container">
			...
			テキスト展示のご来場お申込みを受け付けております。<br>
			ご希望の会場（日程）・時間帯をお選びいただき、必要事項をご入力の上、「入力内容の確認画面へ」をクリックしてください。

			<?php echo form_open('winter21/confirm'); ?>
				<div class="form-box">
					<p class="item-title">ご希望の会場（日程）をお選びください</p>
					<div class="container-fluid">
						<div class="row">
							<div class="col-12 col-md-6">
								<?php if( strtotime(date('Y-m-d')) > strtotime('2021-10-25') ): ?>
									<p class="full-capacity">岡山会場［10月28日（木）］</p>
								<?php else: ?>
									<?php echo form_radio(array(
										'name'	=> 'place',
										'id'	=> 'place1',
										'value'	=> '1',
										'checked'	=> set_checkbox('place', '1', FALSE)
									)); ?>
									<?php echo form_label('岡山会場［10月28日（木）］', 'place1', array('class' => 'for-radio place-label')); ?>
								<?php endif; ?>
							</div>

							<div class="col-12 col-md-6">
								<?php if( strtotime(date('Y-m-d')) > strtotime('2021-10-26') ): ?>
									<p class="full-capacity">福山会場［10月29日（金）］</p>
								<?php else: ?>
									<?php echo form_radio(array(
										'name'	=> 'place',
										'id'	=> 'place2',
									...
									<?php echo form_label('福山会場［10月29日（金）］', 'place2', array('class' => 'for-radio place-label')); ?>
								<?php endif; ?>
							</div>
						</div> <!-- end of .row -->
						...
						<div class="row">
							<div class="col-12 col-md-6">
								<?php if( strtotime(date('Y-m-d')) > strtotime('2021-11-01') ): ?>
									<p class="full-capacity">広島会場［11月4日（木）］</p>
								<?php else: ?>
									<?php echo form_radio(array(
										'name'	=> 'place',
										'id'	=> 'place3',
									...
									<?php echo form_label('広島会場［11月4日（木）］', 'place3', array('class' => 'for-radio place-label')); ?>
								<?php endif; ?>
							</div>

							<div class="col-12 col-md-6">
								<?php if( strtotime(date('Y-m-d')) > strtotime('2021-11-02') ): ?>
									<p class="full-capacity">松山会場［11月5日（金）］</p>
								<?php else: ?>
									<?php echo form_radio(array(
										'name'	=> 'place',
										'id'	=> 'place4',
									...
									<?php echo form_label('松山会場［11月5日（金）］', 'place4', array('class' => 'for-radio place-label')); ?>
								<?php endif; ?>
							</div>
						</div> <!-- end of .row -->
						...
						<div class="row justify-content-center">
							<div class="col-12 col-md-4">
								<?php echo form_button(array(
									'name'		=> 'btn-submit',
									'id'		=> 'btn_disabled',
									'class'		=> 'btn-winter21 btn-disabled',
	...
	<script src="<?= base_url('js/front/winter21_exhibition.js') ?>?var=<?= CACHES_CLEAR_VERSION ?>"></script>
</body>
</html>
