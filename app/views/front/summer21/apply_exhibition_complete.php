	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<?php if( $ERR_STR == '' ): ?>
				...
				<h2 class="complete-comment"><span>受付票は大切に保管いただき、当日必ずご持参ください。</span></h2>
				...
				<div class="row justify-content-center my-5">
					<div class="col-12 col-md-4 mb-2">
						<a href="<?= site_url('summer21/exhibition_reception?reception=' . $RECEPTION) ?>" class="btn-summer21 btn-enabled">受付票&nbsp;&nbsp;&nbsp;<i class="fas fa-chevron-right"></i></a>
					</div>
				</div> <!-- end of .row -->
			<?php else: ?>
			...
			<div class="anchor-to-back">
				<a href="<?= site_url('summer21/' . $OFFICE . '?referer=exhibition_complete') ?>">トップに戻る</a>
			</div>
