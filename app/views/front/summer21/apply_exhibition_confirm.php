...
<body>
	<div class="wrapper">
		<?php if( $PDATA['office'] == 'chushikoku' ): ?>
		...
		<div class="container">
			...
			<?php echo form_open('summer21', array('id' => 'frm_exhibition_confirm')); ?>
	...
	<script src="<?= base_url('js/front/summer21_exhibition_confirm.js') ?>?var=<?= CACHES_CLEAR_VERSION ?>"></script>
</body>
</html>
