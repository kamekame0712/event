				...
				<div class="container">
					<div class="measures-content">
						...
						<div class="measures-list">
							<img src="<?= base_url('img/summer21/measures1.png') ?>" alt="感染対策" class="narrow">
							<img src="<?= base_url('img/summer21/measures2.png') ?>" alt="感染対策" class="narrow">
							<img src="<?= base_url('img/summer21/measures3.png') ?>" alt="感染対策" class="narrow">
							<img src="<?= base_url('img/summer21/measures4.png') ?>" alt="感染対策" class="narrow">
							<img src="<?= base_url('img/summer21/measures5.png') ?>" alt="感染対策" class="wide">
						</div>
