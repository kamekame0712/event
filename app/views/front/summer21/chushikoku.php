						...
						<div class="row justify-content-center mt-3">
							<div class="col-12 col-md-8">
								<p>
									...
									指導内容だけでなく指導方法も新しくなった、または追加された点もあり、
									改訂初年度は特に学校での対応が不十分になることが予想されます。<br>
									ではこの夏、学習塾はどのように子どもたちをフォローするべきか?
									本展示会では、子どもたちを確実にフォローし、秋以降の学習に繋げるためのテキストやシステム・ツールを展示いたします。
									既存のテキストの改訂に加えて、新たなラインナップも登場しております。
									貴塾の夏期講習に最適なテキスト選びのために、是非会場にてご確認ください。
								</p>
							</div>
						</div>
						...
						<div class="row justify-content-center mt-3">
							<div class="col-12 col-md-8">
								<div class="info-ict">
									...
									<p>
										映像教材や英語４技能対策アプリ、プログラミング教材など、会場で実際に体験できます。
										詳しくはスタッフまで！
									</p>
