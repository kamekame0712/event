<?php
	$active_seminar = $active_exhibition = $active_kyushu = $active_analytics =
	$active_webinar21004 = $active_winter21 = $active_manage = '';
	...
	switch( $current ) {
		...
		case 'winter21':		$active_winter21 = 'class="active"';		break;
...
<?php /* ?>
			...
			<li <?= $active_webinar21004 ?>><a class="nav-link" href="<?= site_url('admin/webinar21004') ?>"><i class="fas fa-list-ol"></i><span>申込確認（安河内先生）</span></a></li>
			<li <?= $active_winter21 ?>><a class="nav-link" href="<?= site_url('admin/winter21') ?>"><i class="fas fa-list-ol"></i><span>申込確認（21冬期）</span></a></li>
			<li <?= $active_analytics ?>><a class="nav-link" href="<?= site_url('admin/analytics') ?>"><i class="far fa-chart-bar"></i><span>アクセス状況（21冬期）</span></a></li>
